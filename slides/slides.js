  ...
  arcade :{
    1: { desc: 'En la zona de almacén, colocar en el selector de llave la posición que mantiene las puertas cerradas hasta que se presiona el pulsador.', imgSrc: './img/santa-rosa/arcade/selector-llave-almacen.jpg' },
    2: { desc: 'Poner la radio en modo CD, presionar play y pulsar “Rep” dos veces hasta que aparezca “REP-ALL”. Dejar el volumen en 14.', imgSrc: './img/santa-rosa/arcade/radio.jpg' },
    3: { desc: 'Encender los dos aires acondicionados de la sala de arcade con el mando ubicado encima del Condensador De Flujo de Back To The Future (entrando a mano derecha).', imgSrc: './img/santa-rosa/arcade/aires.jpg' },
    4: { desc: 'Encender Máquina Pong con el botón en la parte superior izquierda trasera. Conectar teclado, presionar F1 para entrar en BIOS, Esc para salir y Enter. El juego inicia automáticamente.', imgSrc: './img/santa-rosa/arcade/pong.jpg' },
    5: { desc: 'En la TV con VHS, presionar stop y rebobinar la película de Back To The Future. Luego presionar play.', imgSrc: './img/santa-rosa/arcade/tv-bttf-vhs.jpg' },
    6: { desc: 'Encender la TV Darth Vader y presionar “TV/DVD”. Seleccionar Español y Play Movie.', imgSrc: './img/santa-rosa/arcade/tv-darth-vader.jpg' },
    7: { desc: 'Encender la Polybius usando la llave de Stranger Things. Abrir la carcasa, presionar el botón rojo de encendido y seleccionar Donkey Kong.', imgSrc: './img/santa-rosa/arcade/polybius.jpg' },
  ...
  cafeteria:{
    1: { desc: 'Encender el aire acondicionado con el mando situado detrás de la nevera.', imgSrc: './img/santa-rosa/cafeteria/aire.jpg' },
    2: { desc: 'Enchufar el sofá rosa al entrar a mano izquierda, para encender las luces.', imgSrc: './img/santa-rosa/cafeteria/sofa-rosa.jpg' },
    3: { desc: 'En la rockola, reproducir el álbum deseado. Presionar los números y los dos últimos dígitos deben ser “00”.', imgSrc: './img/santa-rosa/cafeteria/rockola.jpg' },
    4: { desc: 'Comprobar que las 2 pantallas que simulan ventanas están encendidas.', imgSrc: './img/santa-rosa/cafeteria/ventanas.jpg' },
    5: { desc: 'Asegurarse de que la puerta de acceso a los baños queda cerrada.', imgSrc: './img/santa-rosa/cafeteria/puerta-banos.jpg' }
  },
  garaje: {
...
export const slidesStore = {
  metahuman: {
    ...
    3: { desc: "Encender el iPad y abrir la aplicación de abajo a la derecha.", imgSrc: "./img/store/metahuman/placeholder.jpg" },
    4: { desc: "Comprobar que el metahuman te sigue correctamente.", imgSrc: "./img/store/metahuman/placeholder.jpg" }
  },
  ...
  portatil: {
    1: { desc: "Encender el portátil (código 0007).", imgSrc: "./img/store/portatil/placeholder.jpg" },
    2: { desc: "Iniciar la aplicación correspondiente (ROG Remix). ", imgSrc: "./img/store/portatil/placeholder.jpg" }
  }
};
...
export const slidesPlanetaTerminator = {
  ...
  pantallas: {
    1: { desc: "Pantalla de la moto: encender con el botón situado a la derecha. Está conectada al PC de Joel.", imgSrc: "./img/planeta-terminator/pantallas/placeholder.jpg" },
    2: { desc: "Pantalla al lado de los terminators robots, sala de reunión: se enciende automáticamente.", imgSrc: "./img/planeta-terminator/pantallas/placeholder.jpg" },
  ...
  puertas: {
    1: { desc: "Verificar que todas las puertas estén bien cerradas, girando la llave completamente hacia la derecha.", imgSrc: "./img/planeta-terminator/puertas/placeholder.jpg" }
  }
};
...
export const slidesPlanetaNave = {
  // === ENTRADA ===
  entrada: {
    1: { desc: "Subir todas las Pias, especialmente las grises (son las principales). Primero subir la Pia de Pantallas Altas y su gris para que se conecten a internet.", imgSrc: "/checklist_img/placeholder.jpg" },
    ...
    8: { desc: "Si están abiertas, no tocar nada.", imgSrc: "/checklist_img/placeholder.jpg" },
  ...
  nave: {
    ...
    2: { desc: "** A mano izquierda del ascensor, nada más entrar, encender el display con botones para que se enciendan las luces de colores.", imgSrc: "./img/planeta-nave/nave/placeholder.jpg" },

    // Luces
    3: { desc: "Encender con el interruptor.", imgSrc: "./img/planeta-nave/nave/placeholder.jpg" },
    ...
    6: { desc: "Arranca solo con la luz. Revisar que no tenga errores visibles.", imgSrc: "./img/planeta-nave/nave/placeholder.jpg" },

    // Tablet
    7: { desc: "Si está apagada, tocar la pantalla.", imgSrc: "./img/planeta-nave/nave/placeholder.jpg" },
  ...
  oficina: {
    1: { desc: "Encender el botón que se encuentra tras el televisor que hay al lado del sofá.", imgSrc: "./img/planeta-nave/oficina/placeholder.jpg" },
    ...
    // Puertas
    7: { desc: "2 son falsas.", imgSrc: "./img/planeta-nave/oficina/placeholder.jpg" },
